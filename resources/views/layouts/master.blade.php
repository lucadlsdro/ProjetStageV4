            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <a id="logo_LMD" class="navbar-brand" href="#"> <img src="assets/images/logoLagep.png" height="50px"></a>
                        <a class="navbar-brand" href="{{ url('/') }}">Lagep</a>
                    </div>
                    @if (Session::get('id') == 0)
                    ...
                    <div class="nav navbar-nav">
                        <li>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li> <a class="dropdown-item"  href="{{ url('/getSejourParMoisR') }}">RechercheMoisR</a></li>
